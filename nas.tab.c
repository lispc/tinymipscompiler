...
union YYSTYPE
{
#line 45 "nas.y" /* yacc.c:355  */

  int i;
  char s[500];

#line 190 "nas.tab.c" /* yacc.c:355  */
};
...
{
       0,    58,    58,    59,    63,    64,    68,    69,    74,    75,
      77,    79,    80,    82,    84,    86,    87,    88,    89,    90,
...
yyreduce:
  ...
  switch (yyn)
    {
        case 5:
#line 64 "nas.y" /* yacc.c:1646  */
    { lb[(yyvsp[-1].i)] = pc; }
#line 1300 "nas.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 68 "nas.y" /* yacc.c:1646  */
    { in[pc] = PUSHI; op[pc++] = (yyvsp[0].i); }
#line 1306 "nas.tab.c" /* yacc.c:1646  */
    break;

  case 7:
#line 69 "nas.y" /* yacc.c:1646  */
    { 
		in[pc] = PUSHI;
		str = (char *) malloc(strlen((yyvsp[0].s))+1);
		strcpy(str, (yyvsp[0].s)); op[pc++] = (long) str;
	}
#line 1316 "nas.tab.c" /* yacc.c:1646  */
    break;

  case 8:
#line 74 "nas.y" /* yacc.c:1646  */
    { in[pc] = PUSHR; op[pc++] = (yyvsp[0].i); }
#line 1322 "nas.tab.c" /* yacc.c:1646  */
    break;
...
#line 1334 "nas.tab.c" /* yacc.c:1646  */
  ...
  case 11:
#line 79 "nas.y" /* yacc.c:1646  */
    { in[pc] = POPR; op[pc++] = (yyvsp[0].i); }
#line 1340 "nas.tab.c" /* yacc.c:1646  */
    break;
...
#line 1530 "nas.tab.c" /* yacc.c:1646  */
      default: break;
    }
